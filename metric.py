...
if __name__ == "__main__":
    ...
    solution = pd.DataFrame({'id': [0, 1],'text': ["this is a normal english sentence", "the quick brown fox jumps over the lazy dog"]})
    submission = pd.DataFrame({'id': [0, 1],'text': ["sentence english normal a is this", "lazy the over jumps fox brown quick the dog"]})
    
    print(score(solution, submission, 'id', model_path=model_path, clear_mem=True))
